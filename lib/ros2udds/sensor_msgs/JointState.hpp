...
class JointState : public ros2udds::Topic<JointState>
{
public: 
  ...
  bool serialize(ucdrBuffer* msg_buf, const JointState* topic)
  {
  ...
  bool deserialize(ucdrBuffer* msg_buf, JointState* topic)
  {
