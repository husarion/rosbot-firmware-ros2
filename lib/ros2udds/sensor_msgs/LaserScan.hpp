...
class LaserScan : public ros2udds::Topic<LaserScan>
{
public: 
  ...
  bool serialize(ucdrBuffer* msg_buf, const LaserScan* topic)
  {
  ...
  bool deserialize(ucdrBuffer* msg_buf, LaserScan* topic)
  {
