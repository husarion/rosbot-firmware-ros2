...
class MagneticField : public ros2udds::Topic<MagneticField>
{
public: 
  ...
  bool serialize(ucdrBuffer* msg_buf, const MagneticField* topic)
  {
  ...
  bool deserialize(ucdrBuffer* msg_buf, MagneticField* topic)
  {
