...
class PoseWithCovariance : public ros2udds::Topic<PoseWithCovariance>
{
public:
  ...
  bool serialize(ucdrBuffer* msg_buf, const PoseWithCovariance* topic)
  {
  ...
  bool deserialize(ucdrBuffer* msg_buf, PoseWithCovariance* topic)
  {
