...
class Quaternion : public ros2udds::Topic<Quaternion>
{
public:
    double x;
    double y;
  ...
  bool serialize(ucdrBuffer* msg_buf, const Quaternion* topic)
  {
  ...
  bool deserialize(ucdrBuffer* msg_buf, Quaternion* topic)
  {
