...
class Transform : public ros2udds::Topic<Transform>
{
public:
  ...
  bool serialize(ucdrBuffer* msg_buf, const Transform* topic)
  {
  ...
  bool deserialize(ucdrBuffer* msg_buf, Transform* topic)
  {
