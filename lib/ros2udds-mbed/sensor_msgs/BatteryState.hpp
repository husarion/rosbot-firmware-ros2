...
class BatteryState : public ros2udds::Topic<BatteryState>
{
public: 
  ...
  BatteryState():
    ...
    header(),
    voltage(0), temperature(0), current(0), charge(0), capacity(0), design_capacity(0), percentage(0),
    power_supply_status(0), power_supply_health(0), power_supply_technology(0),
    present(0), cell_voltage_size(1), cell_temperature_size(1)
  { 
    memset(cell_voltage, 0, sizeof(cell_voltage));
    memset(cell_temperature, 0, sizeof(cell_temperature));
    memset(location, 0, sizeof(location));
    memset(serial_number, 0, sizeof(serial_number));
  }

  bool serialize(ucdrBuffer* msg_buf, const BatteryState* topic)
  {
    ucdrBuffer* writer = (ucdrBuffer*)msg_buf;
    (void) header.serialize(writer, &topic->header);
    (void) ucdr_serialize_float(writer, topic->voltage);
    (void) ucdr_serialize_float(writer, topic->temperature);
    ...
    (void) ucdr_serialize_sequence_float(writer, topic->cell_temperature, topic->cell_temperature_size);
  ...
  bool deserialize(ucdrBuffer* msg_buf, BatteryState* topic)
  {
    ucdrBuffer* reader = (ucdrBuffer*)msg_buf;
    (void) header.deserialize(reader, &topic->header);
    (void) ucdr_deserialize_float(reader, &topic->voltage);
    (void) ucdr_deserialize_float(reader, &topic->temperature);
    ...
    (void) ucdr_deserialize_sequence_float(reader, topic->cell_temperature, sizeof(topic->temperature)/sizeof(float), &topic->cell_temperature_size);
