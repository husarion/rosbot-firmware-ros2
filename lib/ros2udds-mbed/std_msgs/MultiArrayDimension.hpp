...
class MultiArrayDimension : public ros2udds::Topic<MultiArrayDimension>
{
public:
  char label[255];
  uint32_t size;
  ...
  bool serialize(ucdrBuffer* msg_buf, const MultiArrayDimension* topic)
  {
  ...
  bool deserialize(ucdrBuffer* msg_buf, MultiArrayDimension* topic)
  {
